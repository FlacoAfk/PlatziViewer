...
def main():
    ...
    try:
        ...
        md.append_courses_to_route("Inglés Avanzado C1", [
        ...
        md.append_courses_to_route("Inglés Básico A1", [
        ...
        md.append_courses_to_route("Inglés Básico A2", [
        ...
        md.append_courses_to_route("Inglés Intermedio Alto B2", [
        ...
        md.append_courses_to_route("Inglés Intermedio B1", [
        ...
        md.append_courses_to_route("Inglés para Propósitos Específicos", [
