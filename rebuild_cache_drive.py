...
def main():
    ...
    print(f"   {len(categories)} categories, {parsed['stats']['totalRoutes']} routes, "
    ...
    for cat in categories:
        ...
        for route in cat['routes']:
            ...
            for course in route.get('courses', []):
                ...
                drive_folder_name, drive_folder_id, match_type = match_course_to_drive(
                    md_name, drive_san, drive_map)
                ...
                if drive_folder_name:
                    ...
                    if drive_folder_id in scanned:
                        ...
                        try:
                            modules, has_pres, pres_id = scan_drive_course(
